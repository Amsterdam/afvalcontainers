    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='enevo.EnevoSite')),
            ],
        ),
        migrations.AddField(
            model_name='enevocontainerslot',
            name='site',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='enevo.EnevoSite'),
        ),
        migrations.AddField(
            model_name='enevocontainerslot',
            name='site_content_type',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='enevo.EnevoSiteContentType'),
        ),
        migrations.AddField(
            model_name='enevocontainer',
            name='container_slot',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='enevo.EnevoContainerSlot'),
        ),
        migrations.AddField(
            model_name='enevocontainer',
            name='site',
        ...
        migrations.AddField(
            ...
            name='site',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='enevo.EnevoSite'),
        ),
    ]
