    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_number', models.CharField(db_index=True, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warranty_date', models.DateTimeField(null=True)),
                ('operational_date', models.DateTimeField(null=True)),
                ('containers', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='wells', to='afvalcontainers.Container')),
            ],
        ),
        migrations.AddField(
