...
class DynamicFieldsMixin(object):
    """Select `fields` from `fields` argument that should be displayed."""

    def _modify_fields(self, fields, filter_fields, omit_fields):
    ...
    def _parse_query_params(self, request):
        ...
        return filter_fields, omit_fields

    @property
    def fields(self):
        """Filter fields according to the `fields` query parameter.
        ...
        filter_fields, omit_fields = self._parse_query_params(request)
        fields = self._modify_fields(fields, filter_fields, omit_fields)
