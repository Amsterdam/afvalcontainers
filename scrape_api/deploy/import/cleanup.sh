...
dc run --rm importer python load_wfs_postgres.py https://map.data.amsterdam.nl/maps/bag verblijfsobjecten,pand 28992

# create all tables if missing
dc run --rm importer python models.py

dc run --rm importer python create_clusters.py
